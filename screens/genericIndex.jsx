      ...
      >
        <HStack>
          <Text style={styles.title}>
            Welcome to My App: Home Scan
          </Text>
        </HStack>
        <Text style={styles.paragraph}>
          This is a generic index page
...
const styles = StyleSheet.create({
  ...
  header: {
    backgroundColor:
      colorHelper.getPrimaryColor(), //"#3498db",
    padding: 20,
    alignItems: "center",
  },
  headerText: {
