...
import { CURRENT_SCREEN_HEIGHT, CURRENT_SCREEN_WIDTH, MAX_BUTTON_SIZE } from '@/constants/dimensions'
import Colors from '@/constants/Colors'
import { GeneralCache } from '@/lib/storage/mmkv'

const theme = (GeneralCache.getItem('theme') ?? Appearance.getColorScheme()) as 'light' | 'dark'
const colors = Colors[theme]
const START_RECORDING_DELAY = 200
const BORDER_WIDTH = MAX_BUTTON_SIZE * 0.1
...
const _CaptureButton: React.FC<Props> = ({
    ...
    const onPanGestureEvent = useAnimatedGestureHandler<PanGestureHandlerGestureEvent, { offsetY?: number; startY?: number }>({
        ...
        onActive: (event, context) => {
            ...
            const startY = context.startY ?? CURRENT_SCREEN_HEIGHT
        ...
        <TapGestureHandler
            ...
            <Reanimated.View {...props} style={[buttonStyle, style]}>
                <PanGestureHandler
                    enabled={enabled}
                    ref={panHandler}
                    failOffsetX={[-CURRENT_SCREEN_WIDTH, CURRENT_SCREEN_WIDTH]}
                    activeOffsetY={[-2, 2]}
